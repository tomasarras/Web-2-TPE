...
<div class="centrar-contenido view">
    <section class="bg-dark borde grande botonera-admin">
        ...
        <div class="botonera">
            <button class="btn btn-primary campos-vacios margen-der ancho" name="{$banda->id_banda}" id="btn-editar">Editar</button>
            <button class="btn btn-primary ancho margen-izq" id="btn-cancelar">Cancelar</button>
        </div>
    </section>
</div>
